		...
		return (
			<>
				<div className={styles.listItemContainer}>
					<Link href="https://medium.com/@2110412039/konflik-panjang-palestina-israel-dan-restrukturisasi-dk-pbb-35fc1a14a18b" passHref>
						<div className={styles.listItem}>
							<div className={styles.listItemName}>
								<Image
									...
									height={16}
								></Image>
								<p>Konflik Panjang Palestina-Israel dan Restrukturisasi DK PBB</p>
							</div>
